...
class AnalysisTypeRow extends StatelessWidget {
  ...
  const AnalysisTypeRow({Key? key, required this.value, required this.onChanged})
      : super(key: key);
    ...
    return Card(
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Text('Analysis Type', style: Theme.of(context).textTheme.titleMedium),
            SegmentedButton<AnalysisType>(
              segments: const [
                ButtonSegment(value: AnalysisType.elastic, label: Text('Elastic')),
                ButtonSegment(
