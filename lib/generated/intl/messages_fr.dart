...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(n) => "Charge ${n}";

  static String m2(label) => "${label} copié";

  static String m3(name) => "Supprimer « ${name} » ?";

  static String m4(label) =>
      "Faites glisser le long de la ligne pour explorer d\'autres valeurs de ${label}.";

  static String m5(limit) =>
      "La température maximale doit dépasser la température de fin de compression, ${limit}.";

  static String m6(n) => "Saisissez x et y pour J${n}.";

  static String m7(n) => "La barre ${n} doit avoir au moins deux nœuds.";

  static String m8(limit) =>
      "L’entrée de la turbine doit être plus chaude que la température de saturation de la chaudière, ${limit} — ou laissez le champ vide pour de la vapeur saturée.";

  static String m9(x) => "Moment d\'encastrement en x = ${x}";

  static String m10(members, joints, equations) =>
      "${members} barres × 3 + ${joints} axes × 2 = ${equations} équations";

  static String m11(path) => "Le long de la barre : ${path}";

  static String m12(count) =>
      "${count} inconnues : deux composantes d’effort d’axe par barre et par nœud, plus les réactions";

  static String m13(index) => "Couche ${index}";

  static String m14(n) => "Barre ${n}";

  static String m15(index) => "Mode ${index}";

  static String m16(n) => "Effort sur la barre en J${n}";

  static String m17(max) => "Vos ${max} derniers calculs dans l’historique";

  static String m18(total) =>
      "Les ${total} outils — conception mécanique, composites, fluides et thermique, vibrations, et plus";

  static String m19(count, total) =>
      "${count} outils sur ${total} sont gratuits. Premium débloque les autres.";

  static String m20(count, max) =>
      "Les ${count} plus récents sont affichés. Premium en affiche jusqu’à ${max}.";

  static String m21(max) =>
      "Premium affiche jusqu’à vos ${max} derniers calculs.";

  static String m22(tool) => "${tool} est un outil Premium";

  static String m23(name) => "${name} (copie)";

  static String m24(name, n) => "${name} (copie ${n})";

  static String m25(count) =>
      "${count} entrées copiées. Utilisez « Importer depuis le presse-papiers » sur l’autre appareil.";

  static String m26(added, skipped) =>
      "${added} importées ; ${skipped} déjà présentes ignorées.";

  static String m27(value) => "Aperçu : ${value}";

  static String m28(count) => "${count} calculs";

  static String m29(name) => "« ${name} » enregistré";

  static String m30(name) => "Renommé en « ${name} »";

  static String m31(x) => "Réaction en x = ${x}";

  static String m32(tool) => "Retirer ${tool} des favoris";
  ...
  static String m34(output, value) => "Actuellement : ${output} = ${value}";

  static String m35(count) =>
      "${count} valeurs donnent ce résultat ; voici la plus proche de votre donnée actuelle.";

  static String m36(input) => "Aucune valeur de ${input} ne donne ce résultat.";

  static String m37(input, output, low, high) =>
      "Aucune valeur de ${input} ne donne ce résultat. En ne modifiant qu’elle, ${output} va de ${low} à ${high}.";

  static String m38(value) => "Auparavant ${value}";

  static String m39(input) =>
      "${input} est renseigné. Calculez pour voir le résultat complet.";

  static String m40(n) => "Cote ${n}";

  static String m41(n) => "État ${n}";

  static String m42(label) => "Et si : ${label}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "Add_Custom_Fluid": MessageLookupByLibrary.simpleMessage(
      "Ajouter un fluide personnalisé",
    ),
    "Add_Custom_Lamina": MessageLookupByLibrary.simpleMessage(
      "Ajouter un pli personnalisé",
    ),
    ...
    "Add_Load": MessageLookupByLibrary.simpleMessage("Ajouter une charge"),
    ...
    "Ads_Removed": MessageLookupByLibrary.simpleMessage(
      "Publicités supprimées",
    ),
    "Ads_Removed_Description": MessageLookupByLibrary.simpleMessage(
      "Merci de soutenir ME Toolkit.",
    ),
    "Aerospace_Engineering": MessageLookupByLibrary.simpleMessage(
      "Génie aérospatial",
    ),
    "Air_Cycle_Note": MessageLookupByLibrary.simpleMessage(
      "Analyse à air froid standard : l’air est un gaz parfait à chaleurs massiques constantes, la chaleur étant fournie et cédée de façon réversible. Les moteurs réels restent nettement en deçà de ces rendements — ce sont des bornes supérieures, utiles pour comparer des conceptions.",
    ),
    "Air_Standard_Cycles": MessageLookupByLibrary.simpleMessage(
      "Cycles Otto, Diesel et Brayton",
    ),
    "All": MessageLookupByLibrary.simpleMessage("Tout"),
    "All_Tools": MessageLookupByLibrary.simpleMessage("Tous les outils"),
    "Allowable_Shear_Stress_Optional": MessageLookupByLibrary.simpleMessage(
      "Contrainte de cisaillement admissible (optionnel)",
    ),
    ...
    "Angle_of_twist": MessageLookupByLibrary.simpleMessage("Angle de torsion"),
    "Anisotropic_material": MessageLookupByLibrary.simpleMessage(
      "Matériau anisotrope",
    ),
    "Answer_No": MessageLookupByLibrary.simpleMessage("Non"),
    "Answer_Yes": MessageLookupByLibrary.simpleMessage("Oui"),
    "Appearance": MessageLookupByLibrary.simpleMessage("APPARENCE"),
    "Applied_Couple_M": MessageLookupByLibrary.simpleMessage(
      "Couple, M (+ sens antihoraire)",
    ),
    "Applied_Force_F": MessageLookupByLibrary.simpleMessage(
      "Force appliquée, F",
    ),
    "Applied_Load": MessageLookupByLibrary.simpleMessage("Charge"),
    ...
    "Axial_Force_Compression": MessageLookupByLibrary.simpleMessage(
      "Barre à deux forces : compression",
    ),
    "Axial_Force_Tension": MessageLookupByLibrary.simpleMessage(
      "Barre à deux forces : traction",
    ),
    "Axial_Load_F": MessageLookupByLibrary.simpleMessage("Charge axiale, F"),
    "Back_Work_Ratio": MessageLookupByLibrary.simpleMessage(
      "Rapport de travail inverse (%)",
    ),
    ...
    "Beam_Determinate_Note": MessageLookupByLibrary.simpleMessage(
      "Isostatique : les réactions découlent du seul équilibre.",
    ),
    ...
    "Beam_Indeterminate_Note": MessageLookupByLibrary.simpleMessage(
      "Hyperstatique : les réactions dépendent de EI, si bien que la section et le matériau les modifient, et pas seulement la flèche.",
    ),
    ...
    "Beam_Load_N": m1,
    "Beam_Loads": MessageLookupByLibrary.simpleMessage("Charges"),
    ...
    "Beam_Model_Note": MessageLookupByLibrary.simpleMessage(
      "Analyse d\'Euler–Bernoulli linéaire élastique sur un maillage de 120 éléments. Le poids propre n\'est pas pris en compte s\'il n\'est pas saisi comme charge répartie, et la déformation d\'effort tranchant est négligée — ce qui sous-estime la flèche d\'une poutre dont la portée est inférieure à environ dix fois la hauteur.",
    ),
    ...
    "Belt_Chain_Drive": MessageLookupByLibrary.simpleMessage(
      "Transmission par courroie / chaîne",
    ),
    "Belt_Length_L": MessageLookupByLibrary.simpleMessage(
      "Longueur de courroie, L",
    ),
    "Belt_Pull_Ft": MessageLookupByLibrary.simpleMessage(
      "Tension de courroie, Ft",
    ),
    ...
    "Bending_Stress_At_Mmax": MessageLookupByLibrary.simpleMessage(
      "Contrainte de flexion à Mmax",
    ),
    "Bending_Stress_Pinion": MessageLookupByLibrary.simpleMessage(
      "Contrainte de flexion, σ (pignon)",
    ),
    "Boiler_Pressure": MessageLookupByLibrary.simpleMessage(
      "Pression chaudière",
    ),
    "Bolt_Grades_Footnote": MessageLookupByLibrary.simpleMessage(
      "La précharge vaut 75 % de la contrainte d\'épreuve sur la section résistante ; le couple découle de T = K·F·d avec K = 0,2, filet brut non lubrifié. K résume tout le frottement en un seul nombre — revêtement, cire ou pâte antigrippante le déplacent entre environ 0,10 et 0,25, et le couple avec lui. Lorsque la précharge compte, mesurez-la plutôt que de vous fier à une clé dynamométrique. Touchez une ligne pour la copier.",
    ),
    "Bolt_Grades_Torque": MessageLookupByLibrary.simpleMessage(
      "Classes de vis & couple",
    ),
    "Bolt_Preload_Torque_Tension": MessageLookupByLibrary.simpleMessage(
      "Précontrainte de boulon / couple-tension",
    ),
    "Bolt_Size": MessageLookupByLibrary.simpleMessage("Taille"),
    "Bolted_Riveted_Joint": MessageLookupByLibrary.simpleMessage(
      "Assemblage boulonné / riveté",
    ),
    ...
    "Buckling_Load": MessageLookupByLibrary.simpleMessage(
      "Charge de flambement",
    ),
    "Buckling_load_of_column": MessageLookupByLibrary.simpleMessage(
      "Charge de flambement d\'un poteau",
    ),
    "Built_In_Presets": MessageLookupByLibrary.simpleMessage("Intégrés"),
    "Calculate": MessageLookupByLibrary.simpleMessage("Calculer"),
    "Calculation": MessageLookupByLibrary.simpleMessage("Calcul"),
    "Calculation_Copied": MessageLookupByLibrary.simpleMessage("Calcul copié"),
    "Cancel": MessageLookupByLibrary.simpleMessage("Annuler"),
    "Carnot_Efficiency": MessageLookupByLibrary.simpleMessage(
      "Rendement de Carnot, mêmes limites (%)",
    ),
    "Center_Distance": MessageLookupByLibrary.simpleMessage("Entraxe"),
    "Center_Distance_C": MessageLookupByLibrary.simpleMessage("Entraxe, C"),
    "Centroid_Radius_Rc": MessageLookupByLibrary.simpleMessage(
      "Rayon du centre de gravité, rc",
    ),
    "Centroid_Rc": MessageLookupByLibrary.simpleMessage(
      "Centre de gravité, rc",
    ),
    ...
    "Clamp_Load_Fi": MessageLookupByLibrary.simpleMessage("Précharge Fi"),
    ...
    "Clear_History_Description": MessageLookupByLibrary.simpleMessage(
      "Ceci supprime tous les calculs enregistrés sur cet appareil.",
    ),
    "Clear_History_Question": MessageLookupByLibrary.simpleMessage(
      "Effacer l\'historique ?",
    ),
    "Clear_Search": MessageLookupByLibrary.simpleMessage(
    ...
    "Collar_Diameter_Dc": MessageLookupByLibrary.simpleMessage(
      "Diamètre moyen du collet, dc",
    ),
    "Collar_Friction_Muc": MessageLookupByLibrary.simpleMessage(
      "Frottement du collet, μc",
    ),
    "Collar_Hint": MessageLookupByLibrary.simpleMessage(
      "Laissez le diamètre du collet à zéro pour une vis tournant sur une butée à roulement, dont le frottement est négligeable devant celui d\'un collet lisse.",
    ),
    "Collar_Torque": MessageLookupByLibrary.simpleMessage("Couple du collet"),
    ...
    "Composite_Failure_Criteria": MessageLookupByLibrary.simpleMessage(
      "Critères de rupture des composites (Tsai-Hill / Tsai-Wu)",
    ),
    ...
    "Curvature_Factor_Ki": MessageLookupByLibrary.simpleMessage(
      "Facteur de courbure, Ki",
    ),
    "Curvature_Factor_Ko": MessageLookupByLibrary.simpleMessage(
      "Facteur de courbure, Ko",
    ),
    "Curvature_Ratio_Rc_H": MessageLookupByLibrary.simpleMessage(
      "Rapport de courbure, rc/h",
    ),
    "Curved_Beam": MessageLookupByLibrary.simpleMessage(
      "Poutre courbe en flexion",
    ),
    "Curved_Beam_Hook_Hint": MessageLookupByLibrary.simpleMessage(
      "La ligne d’action de la charge passe par le centre de courbure, comme sur un crochet de levage : la section supporte N = F et M = F·rc.",
    ),
    "Curved_Beam_Note": MessageLookupByLibrary.simpleMessage(
      "La formule de flexion M·c/I sous-estime la contrainte de la fibre intérieure du facteur Ki, et l’écart croît quand rc/h diminue — sous 5 environ, il dépasse nettement 10 %. Vérifiez d’abord la fibre intérieure.",
    ),
    "Curved_Beam_Sign_Hint": MessageLookupByLibrary.simpleMessage(
      "Un M positif redresse la poutre et met la fibre intérieure en traction ; un M négatif la referme. N s’applique au centre de gravité.",
    ),
    "Custom_Fluid_Hint": MessageLookupByLibrary.simpleMessage(
      "Les deux propriétés varient avec la température : indiquez-la dans le nom, par exemple « Huile hydraulique, 40 °C ».",
    ),
    "Custom_Lamina_Hint": MessageLookupByLibrary.simpleMessage(
      "E1, E2, G12 et ν12 sont obligatoires. Les résistances sont facultatives ; si elles sont renseignées, elles alimentent les critères de Tsai.",
    ),
    "Custom_Material_Hint": MessageLookupByLibrary.simpleMessage(
      "Renseignez ce que vous connaissez : chaque outil n’utilise que les propriétés dont il a besoin. Laissez G vide pour le déduire de E et ν.",
    ),
    "Cutoff_Ratio_Rc": MessageLookupByLibrary.simpleMessage(
      "Rapport d’injection, rc",
    ),
    ...
    "Cycle_Performance": MessageLookupByLibrary.simpleMessage("Performances"),
    "Cycle_States": MessageLookupByLibrary.simpleMessage("États"),
    "Deflection": MessageLookupByLibrary.simpleMessage("Flèche"),
    "Deflection_Delta": MessageLookupByLibrary.simpleMessage("Flèche, δ"),
    "Deflections_and_slopes_of_cantilever_beams":
        MessageLookupByLibrary.simpleMessage(
          "Flèches et pentes des poutres console",
        ),
    ...
    "Delete_Preset_Description": MessageLookupByLibrary.simpleMessage(
      "L’entrée est retirée de cet appareil. Les calculs qui l’ont déjà utilisée conservent leurs valeurs.",
    ),
    ...
    "Density_Rho": MessageLookupByLibrary.simpleMessage("Masse volumique, ρ"),
    "Desc_Air_Standard_Cycles": MessageLookupByLibrary.simpleMessage(
      "Analyse à air froid standard des cycles à allumage commandé, à allumage par compression et de turbine à gaz : tous les états, la chaleur fournie et cédée, le travail net et le rendement thermique.",
    ),
    "Desc_Beam_Analysis": MessageLookupByLibrary.simpleMessage(
      "Résolue par la méthode des déplacements avec des éléments d\'Euler–Bernoulli. Cela couvre, outre les cas isostatiques, la console appuyée, la poutre bi-encastrée et la poutre sur appuis en retrait — autant de cas que l\'équilibre seul ne suffit pas à résoudre.",
    ),
    ...
    "Desc_Beam_Supports": MessageLookupByLibrary.simpleMessage(
      "Choisissez d\'abord les appuis, puis ajoutez les charges. Charges ponctuelles, charges réparties uniformes, triangulaires ou trapézoïdales et moments appliqués se combinent librement.",
    ),
    "Desc_Bearing_Life": MessageLookupByLibrary.simpleMessage(
      "Durée de vie nominale à partir de la capacité de charge dynamique catalogue C, de la charge équivalente appliquée P et de la vitesse n : L10 = (C/P)^p.",
    ),
    "Desc_Belt_Drive": MessageLookupByLibrary.simpleMessage(
      "Géométrie d\'une transmission par courroie ouverte (ou par chaîne à rouleaux, avec les diamètres primitifs) : rapport de vitesse, longueur approximative de courroie et angles d\'enroulement des poulies.",
    ),
    "Desc_Bolt_Grades": MessageLookupByLibrary.simpleMessage(
      "Contrainte d\'épreuve, limite d\'élasticité et résistance à la traction pour les classes de qualité métriques ISO 898-1 et les grades en pouces SAE J429, avec la précharge et le couple de serrage qui découlent de chaque taille et classe. La précharge et le couple sont calculés à partir des résistances tabulées et ne peuvent donc pas les contredire.",
    ),
    ...
    "Desc_Curved_Beam": MessageLookupByLibrary.simpleMessage(
      "Contraintes dans une pièce courbe épaisse — crochet de levage, bâti en C, maillon de chaîne — où la formule de flexion sous-estime la fibre intérieure. Théorie des poutres courbes de Winkler–Bach.",
    ),
    ...
    "Desc_Frame_Joints": MessageLookupByLibrary.simpleMessage(
      "Ajoutez un nœud partout où des barres se rejoignent, où agit une charge ou un couple, où un appui retient la structure ou où une barre se coude. Une charge sur un nœud partagé s’applique à l’axe.",
    ),
    "Desc_Frame_Members": MessageLookupByLibrary.simpleMessage(
      "Chaque barre est un corps rigide. Choisissez ses nœuds dans l’ordre ; trois ou plus forment une barre coudée ou ramifiée, comme un levier ou la branche d’une pince.",
    ),
    "Desc_Ideal_Gas_Process": MessageLookupByLibrary.simpleMessage(
      "État final, travail, chaleur et variation d’entropie d’un gaz parfait soumis à l’une des cinq transformations classiques, à chaleurs massiques constantes.",
    ),
    ...
    "Desc_Power_Screw": MessageLookupByLibrary.simpleMessage(
      "Couple de montée et de descente d\'une charge sur une vis de transmission, son rendement, et si elle retient la charge sans frein. Concerne un cric, un étau, un serre-joint ou la vis mère d\'un chariot de machine.",
    ),
    ...
    "Desc_Rankine_Cycle": MessageLookupByLibrary.simpleMessage(
      "Le cycle à vapeur — pompe, chaudière, turbine et condenseur — avec les propriétés réelles de la vapeur : tous les états, le travail et la chaleur de chaque composant et le rendement du cycle.",
    ),
    ...
    "Desc_Spring_Design": MessageLookupByLibrary.simpleMessage(
      "Indice de ressort, facteur de correction de contrainte de Wahl, raideur et fréquence propre fondamentale estimée (extrémités encastrées) pour un ressort hélicoïdal de compression en fil rond.",
    ),
    ...
    "Desc_Steam_Tables": MessageLookupByLibrary.simpleMessage(
      "Propriétés de l’eau et de la vapeur — saturation, liquide comprimé, vapeur surchauffée et état supercritique — selon la formulation internationale IAPWS-IF97, à partir du couple de grandeurs que vous connaissez.",
    ),
    ...
    "Description_and_Formulas": MessageLookupByLibrary.simpleMessage(
      "Description et formules",
    ),
    "Design_Line": MessageLookupByLibrary.simpleMessage(
      "Droite de dimensionnement, 1/n",
    ),
    "Diameter_D": MessageLookupByLibrary.simpleMessage("Diamètre, d"),
    "Diametral_Interference": MessageLookupByLibrary.simpleMessage(
      "Interférence diamétrale, δ",
    ),
    "Displacement": MessageLookupByLibrary.simpleMessage("Déplacement"),
    "Display_Format": MessageLookupByLibrary.simpleMessage(
      "FORMAT D\'AFFICHAGE",
    ),
    ...
    "Drill_Tap_Footnote": MessageLookupByLibrary.simpleMessage(
      "Les diamètres sont en mm ; les forets en pouces indiquent la désignation avec l\'équivalent en millimètres en dessous. Les forets à tarauder donnent environ 75 % d\'engagement du filetage dans l\'acier, et les trous de passage métriques suivent l\'ISO 273 (séries ajustée et large). Touchez une ligne pour la copier.",
    ),
    ...
    "Eccentricity_E": MessageLookupByLibrary.simpleMessage(
      "Excentricité, e = rc − rn",
    ),
    "Edit": MessageLookupByLibrary.simpleMessage("Modifier"),
    "Edit_Preset": MessageLookupByLibrary.simpleMessage("Modifier l’entrée"),
    ...
    "Enter_Fx_Fy_Components": MessageLookupByLibrary.simpleMessage(
      "Saisissez les composantes Fx et Fy de chaque force (N)",
    ),
    ...
    "Err_Absolute_Zero": MessageLookupByLibrary.simpleMessage(
      "Une température inférieure ou égale au zéro absolu est impossible.",
    ),
    ...
    "Err_Add_One_Member": MessageLookupByLibrary.simpleMessage(
      "Ajoutez au moins une barre.",
    ),
    "Err_Beam_Load_Incomplete": MessageLookupByLibrary.simpleMessage(
      "Complétez chaque champ de chaque charge, ou supprimez la charge.",
    ),
    "Err_C_Positive": MessageLookupByLibrary.simpleMessage(
      "La capacité de charge dynamique C doit être positive.",
    ),
    "Err_Center_Distance_Positive": MessageLookupByLibrary.simpleMessage(
      "L\'entraxe doit être positif.",
    ),
    "Err_Conductivity_Required": MessageLookupByLibrary.simpleMessage(
      "Saisissez une conductivité positive.",
    ),
    "Err_Curved_Beam_Inputs": MessageLookupByLibrary.simpleMessage(
      "Saisissez le rayon intérieur, toutes les dimensions de la section et la charge.",
    ),
    "Err_Cycle_Cutoff": MessageLookupByLibrary.simpleMessage(
      "Le rapport d’injection doit être inférieur au rapport volumétrique.",
    ),
    "Err_Cycle_Inputs": MessageLookupByLibrary.simpleMessage(
      "Saisissez toutes les valeurs nécessaires au cycle.",
    ),
    "Err_Cycle_K": MessageLookupByLibrary.simpleMessage(
      "Le rapport des chaleurs massiques k doit être supérieur à 1.",
    ),
    "Err_Cycle_Peak": m5,
    "Err_Cycle_Positive": MessageLookupByLibrary.simpleMessage(
      "Les pressions et les chaleurs massiques doivent être positives.",
    ),
    "Err_Cycle_Ratio": MessageLookupByLibrary.simpleMessage(
      "Les rapports volumétrique, d’injection et de pression doivent être supérieurs à 1.",
    ),
    ...
    "Err_Efficiency_Range": MessageLookupByLibrary.simpleMessage(
      "Les rendements doivent être supérieurs à 0 % et au plus égaux à 100 %.",
    ),
    ...
    "Err_Enter_Moment_Or_Torque": MessageLookupByLibrary.simpleMessage(
      "Saisissez au moins un moment ou un couple.",
    ),
    ...
    "Err_Member_Unknown_Joint": MessageLookupByLibrary.simpleMessage(
      "Une barre référence un nœud inconnu.",
    ),
    ...
    "Err_Nut_Factor_Positive": MessageLookupByLibrary.simpleMessage(
      "Le facteur d\'écrou K doit être positif.",
    ),
    "Err_P_Positive": MessageLookupByLibrary.simpleMessage(
      "La charge équivalente P doit être positive.",
    ),
    "Err_Poisson_Range": MessageLookupByLibrary.simpleMessage(
      "Le coefficient de Poisson doit être supérieur à −1 et au plus égal à 0,5.",
    ),
    "Err_Polytropic_N": MessageLookupByLibrary.simpleMessage(
      "Utilisez un exposant polytropique positif et différent de 1 — n = 1 correspond à la transformation isotherme.",
    ),
    "Err_Power_Screw_Inputs": MessageLookupByLibrary.simpleMessage(
      "Saisissez le diamètre extérieur, le pas et la charge axiale.",
    ),
    ...
    "Err_Rankine_Inputs": MessageLookupByLibrary.simpleMessage(
      "Saisissez les pressions de la chaudière et du condenseur.",
    ),
    "Err_Rankine_Pressures": MessageLookupByLibrary.simpleMessage(
      "La pression du condenseur doit être inférieure à celle de la chaudière.",
    ),
    "Err_Rankine_Range": MessageLookupByLibrary.simpleMessage(
      "Le condenseur doit fonctionner entre 0,611 kPa et la pression critique, et la chaudière à 100 MPa au plus.",
    ),
    "Err_Rankine_Supercritical": MessageLookupByLibrary.simpleMessage(
      "Une chaudière au-dessus de la pression critique nécessite une température d’entrée turbine.",
    ),
    ...
    "Err_Span_Positive": MessageLookupByLibrary.simpleMessage(
      "La portée doit être supérieure à zéro.",
    ),
    ...
    "Err_Steam_Above_Critical": MessageLookupByLibrary.simpleMessage(
      "Au-dessus de la pression critique, 22,064 MPa, il n’y a pas de saturation : l’eau passe de liquide à vapeur sans bouillir.",
    ),
    "Err_Steam_Missing": MessageLookupByLibrary.simpleMessage(
      "Saisissez les valeurs nécessaires à cette recherche.",
    ),
    "Err_Steam_Pressure_Range": MessageLookupByLibrary.simpleMessage(
      "La pression de saturation va de 0,611 kPa (0,0887 psi) à la pression critique, 22,064 MPa (3200 psi).",
    ),
    "Err_Steam_Quality": MessageLookupByLibrary.simpleMessage(
      "Le titre doit être compris entre 0 et 1.",
    ),
    "Err_Steam_Range": MessageLookupByLibrary.simpleMessage(
      "Hors du domaine d’IAPWS-IF97, qui couvre 0–800 °C jusqu’à 100 MPa et jusqu’à 2000 °C à 50 MPa au plus.",
    ),
    "Err_Steam_Temperature_Range": MessageLookupByLibrary.simpleMessage(
      "L’eau ne bout qu’entre 0,01 °C (32 °F) et le point critique, 373,95 °C (705,1 °F).",
    ),
    ...
    "Find_Torque": MessageLookupByLibrary.simpleMessage("Calculer le couple"),
    "Fit": MessageLookupByLibrary.simpleMessage("Ajustement"),
    "Fits_Footnote": MessageLookupByLibrary.simpleMessage(
      "Ajustements en système alésage normal pour 1 à 500 mm. Chaque cellule indique l\'écart supérieur sur l\'écart inférieur, en µm par rapport à la dimension nominale ; un jeu négatif est un serrage. Les bandes s\'étendent de la borne inférieure à la borne supérieure. Les ajustements d\'arbre c, s et u ne sont pas listés car leurs écarts se répartissent en bandes de taille plus fines.",
    ),
    "Fits_Tolerances": MessageLookupByLibrary.simpleMessage(
      "Ajustements & tolérances (ISO 286)",
    ),
    "Fixing_Moment_At_X": m9,
    "Flange_Inside": MessageLookupByLibrary.simpleMessage(
      "Semelle côté intérieur",
    ),
    "Flange_Outside": MessageLookupByLibrary.simpleMessage(
      "Semelle côté extérieur",
    ),
    ...
    "Format_Decimal": MessageLookupByLibrary.simpleMessage("Décimal"),
    "Format_Engineering": MessageLookupByLibrary.simpleMessage("Ingénierie"),
    ...
    "Frame_Geometry": MessageLookupByLibrary.simpleMessage("Bâti"),
    "Frame_Member_Path": m11,
    "Frame_Note": MessageLookupByLibrary.simpleMessage(
      "Les efforts d’axe sont ceux que chaque axe exerce sur la barre indiquée ; la barre exerce sur l’axe un effort égal et opposé. θ est mesuré dans le sens trigonométrique depuis +x.",
    ),
    "Frame_Pin_Step": MessageLookupByLibrary.simpleMessage(
      "Chaque axe : ΣFx = 0, ΣFy = 0 avec ses barres, charges et appui",
    ),
    ...
    "Gas_Constant_R": MessageLookupByLibrary.simpleMessage(
      "Constante massique du gaz, R",
    ),
    "Gas_Mass_M": MessageLookupByLibrary.simpleMessage("Masse, m"),
    "Gas_Presets": MessageLookupByLibrary.simpleMessage("Gaz parfaits"),
    ...
    "Gear_Teeth_N2": MessageLookupByLibrary.simpleMessage(
      "Dents de la roue, N2",
    ),
    ...
    "Goodman_Caption": MessageLookupByLibrary.simpleMessage(
      "La droite de charge part de l’origine et passe par le point de fonctionnement. Là où elle rencontre la droite de Goodman, la pièce rompt ; n indique où la pièce se situe sur cette droite.",
    ),
    "Goodman_Diagram": MessageLookupByLibrary.simpleMessage(
      "Diagramme de Goodman",
    ),
    "Goodman_Line": MessageLookupByLibrary.simpleMessage("Droite de Goodman"),
    "Grade_Class": MessageLookupByLibrary.simpleMessage("Classe"),
    ...
    "Heat_Input_Spec": MessageLookupByLibrary.simpleMessage(
      "Apport de chaleur donné par",
    ),
    "Heat_Rejected_Qout": MessageLookupByLibrary.simpleMessage(
      "Chaleur cédée, q_out",
    ),
    "Heat_Spec_Heat": MessageLookupByLibrary.simpleMessage("Chaleur fournie"),
    "Heat_Spec_Peak": MessageLookupByLibrary.simpleMessage(
      "Température maximale",
    ),
    "Heat_Transfer_Q": MessageLookupByLibrary.simpleMessage(
      "Chaleur échangée, Q",
    ),
    ...
    "Holds_With_Collar": MessageLookupByLibrary.simpleMessage(
      "Retient avec le collet",
    ),
    "Hole_um": MessageLookupByLibrary.simpleMessage("Alésage (µm)"),
    "Hook_Load_F": MessageLookupByLibrary.simpleMessage("Charge, F"),
    ...
    "IF97_Region": MessageLookupByLibrary.simpleMessage("Région IAPWS-IF97"),
    "Ideal_Gas_Note": MessageLookupByLibrary.simpleMessage(
      "Les chaleurs massiques sont prises à leur valeur à température ambiante. Au-delà d’environ 600 K, cp augmente sensiblement avec la température et des tables à chaleurs massiques variables sont préférables.",
    ),
    ...
    "Inlet_Temperature_T1": MessageLookupByLibrary.simpleMessage(
      "Température d’admission, T₁",
    ),
    "Inner_Fibre_Stress": MessageLookupByLibrary.simpleMessage(
      "Contrainte fibre intérieure, σi",
    ),
    "Inner_Flange_Thickness_T1": MessageLookupByLibrary.simpleMessage(
      "Épaisseur semelle intérieure, t1",
    ),
    "Inner_Flange_Width_B1": MessageLookupByLibrary.simpleMessage(
      "Largeur semelle intérieure, b1",
    ),
    "Inner_Radius_Ri": MessageLookupByLibrary.simpleMessage(
      "Rayon intérieur, ri",
    ),
    "Inner_Width_Bi": MessageLookupByLibrary.simpleMessage(
      "Largeur côté intérieur, bi",
    ),
    ...
    "Lamina_Preset_Note": MessageLookupByLibrary.simpleMessage(
      "Les préréglages sont des valeurs typiques de Tsai & Hahn. Ils remplissent E1, E2, G12 et ν12, ainsi que les résistances lorsque l’outil les demande ; ν23 n’y est pas publié et reste tel que saisi.",
    ),
    "Lamina_Presets": MessageLookupByLibrary.simpleMessage(
      "Plis unidirectionnels",
    ),
    "Lamina_engineering_constants": MessageLookupByLibrary.simpleMessage(
      "Constantes techniques d\'un pli",
    ),
    "Lamina_stressstrain": MessageLookupByLibrary.simpleMessage(
      "Contrainte/déformation d\'un pli",
    ),
    "Laminate_3D_properties": MessageLookupByLibrary.simpleMessage(
      "Propriétés 3D d\'un stratifié",
    ),
    "Laminate_plane_properties": MessageLookupByLibrary.simpleMessage(
      "Propriétés planes d\'un stratifié",
    ),
    "Laminate_stressstrain": MessageLookupByLibrary.simpleMessage(
      "Contrainte/déformation d\'un stratifié",
    ),
    ...
    "Lead_L": MessageLookupByLibrary.simpleMessage("Pas hélicoïdal"),
    ...
    "Leg_Size_W": MessageLookupByLibrary.simpleMessage("Gorge de soudure, w"),
    "Lewis_Form_Factor_Y": MessageLookupByLibrary.simpleMessage(
      "Facteur de forme de Lewis, Y (pignon)",
    ),
    "List_View": MessageLookupByLibrary.simpleMessage("Vue en liste"),
    "Load_Case": MessageLookupByLibrary.simpleMessage("Cas de charge"),
    "Load_Couple_M": MessageLookupByLibrary.simpleMessage(
      "Moment, M (sens antihoraire +)",
    ),
    "Load_Ends_At": MessageLookupByLibrary.simpleMessage("Finit à"),
    ...
    "Load_Line": MessageLookupByLibrary.simpleMessage("Droite de charge"),
    "Load_Magnitude_P": MessageLookupByLibrary.simpleMessage(
      "Intensité, P (vers le bas +)",
    ),
    "Load_Position_X": MessageLookupByLibrary.simpleMessage("Position, x"),
    "Load_Starts_At": MessageLookupByLibrary.simpleMessage("Débute à"),
    ...
    "Load_Type_Distributed": MessageLookupByLibrary.simpleMessage("Répartie"),
    "Load_Type_Point": MessageLookupByLibrary.simpleMessage("Ponctuelle"),
    "Loading_Hook": MessageLookupByLibrary.simpleMessage("Charge de crochet"),
    ...
    "Maximum_Shear": MessageLookupByLibrary.simpleMessage(
    ...
    "Mean_Moment_Mm": MessageLookupByLibrary.simpleMessage("Moment moyen, Mm"),
    "Mean_Torque_Tm": MessageLookupByLibrary.simpleMessage("Couple moyen, Tm"),
    ...
    "Member_Forces": MessageLookupByLibrary.simpleMessage(
      "Efforts dans les barres (+ traction, \\u2212 compression)",
    ),
    "Member_N": m14,
    "Members": MessageLookupByLibrary.simpleMessage("Barres"),
    "Menu_Back": MessageLookupByLibrary.simpleMessage("Précédent"),
    "Menu_Cut": MessageLookupByLibrary.simpleMessage("Couper"),
    "Menu_Edit": MessageLookupByLibrary.simpleMessage("Édition"),
    "Menu_Export": MessageLookupByLibrary.simpleMessage(
      "Partager ou exporter…",
    ),
    "Menu_File": MessageLookupByLibrary.simpleMessage("Fichier"),
    "Menu_Find_Tool": MessageLookupByLibrary.simpleMessage(
      "Rechercher un outil…",
    ),
    "Menu_Go": MessageLookupByLibrary.simpleMessage("Aller"),
    "Menu_Help": MessageLookupByLibrary.simpleMessage("Aide"),
    "Menu_Paste": MessageLookupByLibrary.simpleMessage("Coller"),
    "Menu_Redo": MessageLookupByLibrary.simpleMessage("Rétablir"),
    "Menu_Save_To_Project": MessageLookupByLibrary.simpleMessage(
      "Enregistrer dans un projet…",
    ),
    "Menu_Select_All": MessageLookupByLibrary.simpleMessage(
      "Tout sélectionner",
    ),
    "Menu_Send_Feedback": MessageLookupByLibrary.simpleMessage(
      "Envoyer un commentaire…",
    ),
    "Menu_Settings": MessageLookupByLibrary.simpleMessage("Réglages…"),
    "Menu_Tool_Library": MessageLookupByLibrary.simpleMessage(
      "Bibliothèque d’outils",
    ),
    "Menu_Undo": MessageLookupByLibrary.simpleMessage("Annuler"),
    ...
    "Menu_View": MessageLookupByLibrary.simpleMessage("Présentation"),
    "Menu_Window": MessageLookupByLibrary.simpleMessage("Fenêtre"),
    "Metric_Coarse": MessageLookupByLibrary.simpleMessage("Métrique gros pas"),
    ...
    "Mohrs_Circle_for_Plane_Stress": MessageLookupByLibrary.simpleMessage(
      "Cercle de Mohr pour l\'état plan de contraintes",
    ),
    "Moment_Carried_M": MessageLookupByLibrary.simpleMessage(
      "Moment fléchissant, M",
    ),
    ...
    "Moments_of_inertia_of_plane_areas": MessageLookupByLibrary.simpleMessage(
      "Moments d\'inertie des surfaces planes",
    ),
    ...
    "MoreApps": MessageLookupByLibrary.simpleMessage("Plus d\'applications"),
    "More_Actions": MessageLookupByLibrary.simpleMessage("Autres actions"),
    "MyFavourite": MessageLookupByLibrary.simpleMessage("Mes favoris"),
    "My_Materials": MessageLookupByLibrary.simpleMessage("Mes matériaux"),
    "My_Presets": MessageLookupByLibrary.simpleMessage("Personnalisés"),
    ...
    "Net_Power": MessageLookupByLibrary.simpleMessage("Puissance nette"),
    "Net_Work": MessageLookupByLibrary.simpleMessage("Travail net, w_net"),
    "Neutral_Axis_Rn": MessageLookupByLibrary.simpleMessage("Axe neutre, rn"),
    "Neutral_Radius_Rn": MessageLookupByLibrary.simpleMessage(
      "Rayon de l’axe neutre, rn",
    ),
    ...
    "No_Custom_Presets_Message": MessageLookupByLibrary.simpleMessage(
      "Aucune entrée personnelle pour l’instant. Touchez Ajouter, ou dupliquez un élément intégré ci-dessous et modifiez ce qui diffère.",
    ),
    ...
    "No_Gases_Found": MessageLookupByLibrary.simpleMessage("Aucun gaz trouvé"),
    "No_History_Yet": MessageLookupByLibrary.simpleMessage(
      "Aucun historique pour le moment",
    ),
    "No_Matches": MessageLookupByLibrary.simpleMessage("Aucun résultat"),
    "No_Matches_Description": MessageLookupByLibrary.simpleMessage(
      "Essayez une autre taille ou réinitialisez les filtres.",
    ),
    ...
    "Normal_Force_N": MessageLookupByLibrary.simpleMessage(
      "Effort normal, N (+ traction)",
    ),
    "Not_a_number": MessageLookupByLibrary.simpleMessage("Pas un nombre"),
    "Note_Polar_Moment": MessageLookupByLibrary.simpleMessage(
      "J = Ix + Iy est le moment quadratique polaire. Ce n\'est pas la constante de torsion de Saint-Venant pour les sections non circulaires.",
    ),
    "Nothing_To_Export": MessageLookupByLibrary.simpleMessage(
      "Aucune entrée personnelle à exporter pour l’instant.",
    ),
    ...
    "Nut_Factor_K": MessageLookupByLibrary.simpleMessage(
      "Facteur d\'écrou, K (0,2 par défaut — typique pour un acier non lubrifié ; env. 0,15 lubrifié/revêtu, env. 0,2-0,3 à sec)",
    ),
    "Onlynote": MessageLookupByLibrary.simpleMessage("Onlynote"),
    "Operating_Force_F": MessageLookupByLibrary.simpleMessage(
      "Force de service, F",
    ),
    "Operating_Point": MessageLookupByLibrary.simpleMessage(
      "Point de fonctionnement",
    ),
    "Optional_For_Bending_Contact": MessageLookupByLibrary.simpleMessage(
      "Optionnel — pour la contrainte de flexion/contact",
    ),
    "Optional_For_Deflection_Frequency": MessageLookupByLibrary.simpleMessage(
      "Optionnel — pour la flèche/contrainte de service et la fréquence",
    ),
    "Orthotropic_material": MessageLookupByLibrary.simpleMessage(
      "Matériau orthotrope",
    ),
    "Outer_Fibre_Stress": MessageLookupByLibrary.simpleMessage(
      "Contrainte fibre extérieure, σo",
    ),
    "Outer_Flange_Thickness_T2": MessageLookupByLibrary.simpleMessage(
      "Épaisseur semelle extérieure, t2",
    ),
    "Outer_Flange_Width_B2": MessageLookupByLibrary.simpleMessage(
      "Largeur semelle extérieure, b2",
    ),
    "Outer_Radius_Ro": MessageLookupByLibrary.simpleMessage(
      "Rayon extérieur, ro",
    ),
    "Outer_Width_Bo": MessageLookupByLibrary.simpleMessage(
      "Largeur côté extérieur, bo",
    ),
    ...
    "Per_Unit_Mass": MessageLookupByLibrary.simpleMessage("Par unité de masse"),
    ...
    "Phase_Wet_Mixture": MessageLookupByLibrary.simpleMessage(
      "Mélange liquide-vapeur",
    ),
    "Pick_Fluid": MessageLookupByLibrary.simpleMessage("Choisir un fluide"),
    "Pick_Gas": MessageLookupByLibrary.simpleMessage("Choisir un gaz"),
    "Pick_Lamina": MessageLookupByLibrary.simpleMessage("Choisir un composite"),
    ...
    "Pinion_Pitch_Diameter_D1": MessageLookupByLibrary.simpleMessage(
      "Diamètre primitif du pignon, d1",
    ),
    ...
    "Power_Screw": MessageLookupByLibrary.simpleMessage("Vis de transmission"),
    "Power_Screw_Note": MessageLookupByLibrary.simpleMessage(
      "Frottement de Coulomb sur un rayon moyen unique, comme le suppose la démonstration de Shigley. Le coefficient réel dépend du couple de matériaux, du lubrifiant et de l\'usure du filet ; 0,10 à 0,20 couvre la plupart des vis acier sur bronze — une fourchette plus large que la précision de la plupart des chiffres ci-dessus.",
    ),
    "Precision": MessageLookupByLibrary.simpleMessage("PRÉCISION"),
    ...
    "Premium_Benefit_Solve": MessageLookupByLibrary.simpleMessage(
      "Résoudre tout calcul à rebours pour la donnée voulue",
    ),
    "Premium_Benefit_Sweep": MessageLookupByLibrary.simpleMessage(
      "Graphiques de balayage de paramètres",
    ),
    ...
    "Pressure_P": MessageLookupByLibrary.simpleMessage("Pression, p"),
    ...
    "Process_Isentropic": MessageLookupByLibrary.simpleMessage("Isentropique"),
    "Process_Isobaric": MessageLookupByLibrary.simpleMessage("Isobare"),
    "Process_Isochoric": MessageLookupByLibrary.simpleMessage("Isochore"),
    "Process_Isothermal": MessageLookupByLibrary.simpleMessage("Isotherme"),
    "Process_Label": MessageLookupByLibrary.simpleMessage("Transformation"),
    "Process_Polytropic": MessageLookupByLibrary.simpleMessage("Polytropique"),
    "Process_Totals": MessageLookupByLibrary.simpleMessage("Masse totale"),
    ...
    "Project_Saved": m29,
    "Project_Updated": m30,
    "Proof_Strength_Sp": MessageLookupByLibrary.simpleMessage("Épreuve Sp"),
    ...
    "Pump_Work": MessageLookupByLibrary.simpleMessage("Travail de pompe, w_p"),
    ...
    "Purchase_Pending": MessageLookupByLibrary.simpleMessage(
      "Achat en attente d\'approbation.",
    ),
    "Purchase_Success": MessageLookupByLibrary.simpleMessage(
      "Les publicités ont été supprimées définitivement.",
    ),
    ...
    "Pv_Diagram": MessageLookupByLibrary.simpleMessage("Diagramme p–v"),
    "Quality_X": MessageLookupByLibrary.simpleMessage("Titre, x"),
    "Radial_Depth_H": MessageLookupByLibrary.simpleMessage(
      "Hauteur radiale, h",
    ),
    ...
    "Rankine_Cycle": MessageLookupByLibrary.simpleMessage("Cycle de Rankine"),
    "Rankine_Hint": MessageLookupByLibrary.simpleMessage(
      "Laissez la température vide pour de la vapeur saturée à l’entrée de la turbine ; indiquez un débit massique pour obtenir aussi la puissance.",
    ),
    "Rankine_Note": MessageLookupByLibrary.simpleMessage(
      "Cycle de Rankine simple, avec les propriétés de la vapeur selon IAPWS-IF97. Le travail de pompe est pris égal à v·Δp ; les pertes de charge de la chaudière, du condenseur et des conduites sont négligées.",
    ),
    "Rankine_State_1": MessageLookupByLibrary.simpleMessage("1 · Entrée pompe"),
    ...
    "Rankine_Wet_Exhaust": MessageLookupByLibrary.simpleMessage(
      "La turbine rejette une vapeur de titre inférieur à 88 %. Cette humidité érode les aubes des derniers étages — augmentez la surchauffe ou ajoutez une resurchauffe.",
    ),
    ...
    "Remove_Load": MessageLookupByLibrary.simpleMessage("Supprimer la charge"),
    ...
    "Restore_Not_Found": MessageLookupByLibrary.simpleMessage(
      "Aucun achat précédent de « Supprimer les publicités » n\'a été trouvé.",
    ),
    "Restore_Purchases": MessageLookupByLibrary.simpleMessage(
      "Restaurer les achats",
    ),
    "Restore_Success": MessageLookupByLibrary.simpleMessage(
      "Votre achat « Supprimer les publicités » a été restauré.",
    ),
    "Restoring": MessageLookupByLibrary.simpleMessage("Restauration en cours…"),
    "Result": MessageLookupByLibrary.simpleMessage("Résultat"),
    "Result_Copied": MessageLookupByLibrary.simpleMessage("Résultat copié"),
    "Result_Precision": MessageLookupByLibrary.simpleMessage(
      "Précision du résultat",
    ),
    "Result_Strain": MessageLookupByLibrary.simpleMessage(
      "Déformation résultante",
    ),
    "Result_Stress": MessageLookupByLibrary.simpleMessage(
    ...
    "Roller_Horizontal": MessageLookupByLibrary.simpleMessage(
      "Appui à rouleau (réaction horizontale)",
    ),
    ...
    "Saturation_Dome": MessageLookupByLibrary.simpleMessage(
    ...
    "Screw_Efficiency": MessageLookupByLibrary.simpleMessage("Rendement"),
    "Screw_Pitch_P": MessageLookupByLibrary.simpleMessage("Pas, p"),
    "Search": MessageLookupByLibrary.simpleMessage("Rechercher"),
    "Search_Bolt_Size_Grade": MessageLookupByLibrary.simpleMessage(
      "Rechercher une taille ou une classe",
    ),
    "Search_Fluids": MessageLookupByLibrary.simpleMessage(
      "Rechercher un fluide",
    ),
    "Search_Gases": MessageLookupByLibrary.simpleMessage("Rechercher des gaz"),
    ...
    "Search_Thread_Size": MessageLookupByLibrary.simpleMessage(
      "Rechercher une taille de filetage",
    ),
    "Search_Tools": MessageLookupByLibrary.simpleMessage("Rechercher un outil"),
    ...
    "Section_Fills_Combined": MessageLookupByLibrary.simpleMessage(
      "Un profilé normalisé remplit A, Ix et c = d/2 pour l’effort normal et la flexion.",
    ),
    "Section_Fills_Extreme_Fibre": MessageLookupByLibrary.simpleMessage(
      "Un profilé normalisé remplit Ix et y = d/2, la fibre extrême où la contrainte de flexion est maximale.",
    ),
    "Section_Fills_Neutral_Axis": MessageLookupByLibrary.simpleMessage(
      "Un profilé normalisé remplit Q, Ix et l’épaisseur de l’âme à l’axe neutre, où la contrainte de cisaillement est maximale.",
    ),
    "Section_Fills_Weak_Axis": MessageLookupByLibrary.simpleMessage(
      "Un profilé normalisé remplit Iy, l’axe faible, qui gouverne un poteau non contreventé.",
    ),
    ...
    "Section_I": MessageLookupByLibrary.simpleMessage("Profil en I"),
    "Section_Loading": MessageLookupByLibrary.simpleMessage("Chargement"),
    "Section_Loads": MessageLookupByLibrary.simpleMessage(
      "Efforts dans la section",
    ),
    ...
    "Section_Rectangle": MessageLookupByLibrary.simpleMessage("Rectangle"),
    "Section_Round_Tube": MessageLookupByLibrary.simpleMessage("Tube rond"),
    "Section_Shape": MessageLookupByLibrary.simpleMessage("Section"),
    "Section_Solid_Round": MessageLookupByLibrary.simpleMessage("Rond plein"),
    "Section_T": MessageLookupByLibrary.simpleMessage("Profil en T"),
    "Section_To_Scale": MessageLookupByLibrary.simpleMessage(
      "Section à l’échelle",
    ),
    "Section_Trapezoid": MessageLookupByLibrary.simpleMessage("Trapèze"),
    ...
    "See_Premium": MessageLookupByLibrary.simpleMessage("Découvrir Premium"),
    "Self_Locking_Thread": MessageLookupByLibrary.simpleMessage(
      "Irréversible au filet",
    ),
    ...
    "Shaft_power_and_torque": MessageLookupByLibrary.simpleMessage(
      "Puissance et couple d\'un arbre",
    ),
    ...
    "Shear_Modulus_G": MessageLookupByLibrary.simpleMessage(
    ...
    "Simply_Supported_Beam_Note": MessageLookupByLibrary.simpleMessage(
      "Poutre simplement appuyée — articulation fixe en A (gauche), appui à rouleau en B (droite)",
    ),
    "Single_Shear": MessageLookupByLibrary.simpleMessage("Simple cisaillement"),
    "Slope": MessageLookupByLibrary.simpleMessage("Pente"),
    "Small_Pulley_Diameter_D1": MessageLookupByLibrary.simpleMessage(
      "Diamètre de la petite poulie, d1",
    ),
    "Solid_Height": MessageLookupByLibrary.simpleMessage(
      "Hauteur à spires jointives",
    ),
    "Solve": MessageLookupByLibrary.simpleMessage("Résoudre"),
    "Solve_By_Changing": MessageLookupByLibrary.simpleMessage("En modifiant"),
    "Solve_Current_Value": m34,
    "Solve_For": MessageLookupByLibrary.simpleMessage(
      "Résoudre pour une donnée",
    ),
    "Solve_For_Description": MessageLookupByLibrary.simpleMessage(
      "Fixez le résultat voulu et choisissez la donnée à faire varier ; l’app trouve la valeur qui le donne.",
    ),
    "Solve_Nearest_Of": m35,
    "Solve_No_Solution": m36,
    "Solve_No_Solution_Range": m37,
    "Solve_Target_Output": MessageLookupByLibrary.simpleMessage("Résultat"),
    "Solve_Target_Value": MessageLookupByLibrary.simpleMessage("Valeur cible"),
    "Solve_Use_Value": MessageLookupByLibrary.simpleMessage(
      "Utiliser cette valeur",
    ),
    "Solve_Was": m38,
    "Solved_Value_Filled": m39,
    "Span_L": MessageLookupByLibrary.simpleMessage("Portée, L"),
    "Span_L_Short": MessageLookupByLibrary.simpleMessage("Portée L"),
    ...
    "Specific_Heat_Ratio_K": MessageLookupByLibrary.simpleMessage(
      "Rapport des chaleurs massiques, k",
    ),
    ...
    "Speed_N": MessageLookupByLibrary.simpleMessage("Vitesse, n"),
    "Speed_Of_Sound": MessageLookupByLibrary.simpleMessage("Vitesse du son, w"),
    "Speed_Ratio": MessageLookupByLibrary.simpleMessage("Rapport de vitesse"),
    "Spring_Index_C": MessageLookupByLibrary.simpleMessage(
      "Indice de ressort, C",
    ),
    "Spring_Rate_K": MessageLookupByLibrary.simpleMessage("Raideur, k"),
    ...
    "Steam_Lookup": MessageLookupByLibrary.simpleMessage("Rechercher par"),
    "Steam_Lookup_PH": MessageLookupByLibrary.simpleMessage(
      "Pression et enthalpie",
    ),
    ...
    "Steam_State": MessageLookupByLibrary.simpleMessage("État"),
    ...
    "Steam_Tables_Note": MessageLookupByLibrary.simpleMessage(
      "L’enthalpie, l’énergie interne et l’entropie sont comptées à partir du liquide saturé au point triple — la référence de toutes les tables de vapeur modernes — : les valeurs se combinent donc avec celles d’une table imprimée.",
    ),
    ...
    "Stiffness_Matrix_Q": MessageLookupByLibrary.simpleMessage(
      "Matrice de rigidité Q",
    ),
    "Straight_Beam_Inner": MessageLookupByLibrary.simpleMessage(
      "σi en poutre droite (M·c/I)",
    ),
    "Straight_Beam_Outer": MessageLookupByLibrary.simpleMessage(
      "σo en poutre droite (M·c/I)",
    ),
    "Strain": MessageLookupByLibrary.simpleMessage("Déformation"),
    "Strength_S": MessageLookupByLibrary.simpleMessage("S (cisaillement plan)"),
    "Strength_Xc": MessageLookupByLibrary.simpleMessage(
      "Xc (compression fibre)",
    ),
    "Strength_Xt": MessageLookupByLibrary.simpleMessage("Xt (traction fibre)"),
    "Strength_Yc": MessageLookupByLibrary.simpleMessage(
      "Yc (compression transverse)",
    ),
    "Strength_Yt": MessageLookupByLibrary.simpleMessage(
      "Yt (traction transverse)",
    ),
    "Stress": MessageLookupByLibrary.simpleMessage("Contrainte"),
    "Stress_Area_As": MessageLookupByLibrary.simpleMessage(
      "Section résistante",
    ),
    "Stress_At_Diameter": MessageLookupByLibrary.simpleMessage(
      "Contraintes à ce diamètre",
    ),
    "Stress_Concentration_Defaults": MessageLookupByLibrary.simpleMessage(
      "Facteurs de concentration de contrainte (par défaut : rainure de clavette profilée) et facteur de sécurité cible",
    ),
    "Stress_Results": MessageLookupByLibrary.simpleMessage(
      "Résultats de contrainte",
    ),
    ...
    "Stresses_in_a_thin_walled_cylindrical_pressure_vessel":
        MessageLookupByLibrary.simpleMessage(
          "Contraintes dans un réservoir cylindrique à paroi mince",
        ),
    "Stresses_in_the_wall_of_a_spherical_shell":
        MessageLookupByLibrary.simpleMessage(
          "Contraintes dans la paroi d\'une coque sphérique",
        ),
    ...
    "Superheated_Exhaust": MessageLookupByLibrary.simpleMessage("Surchauffée"),
    ...
    "Support_Cantilever_Left": MessageLookupByLibrary.simpleMessage(
      "Console encastrée à gauche",
    ),
    "Support_Cantilever_Right": MessageLookupByLibrary.simpleMessage(
      "Console encastrée à droite",
    ),
    "Support_Fixed": MessageLookupByLibrary.simpleMessage("Encastrement"),
    ...
    "Swap": MessageLookupByLibrary.simpleMessage("Inverser"),
    ...
    "Tab_Fluids": MessageLookupByLibrary.simpleMessage("Fluides"),
    "Tab_Laminae": MessageLookupByLibrary.simpleMessage("Plis"),
    "Tab_Solids": MessageLookupByLibrary.simpleMessage("Solides"),
    "Tab_Thermal": MessageLookupByLibrary.simpleMessage("Thermique"),
    "Tangential_Load_Wt": MessageLookupByLibrary.simpleMessage(
      "Effort tangentiel, Wt",
    ),
    "Tap_Drill": MessageLookupByLibrary.simpleMessage("Foret à tarauder"),
    "Target_Factor_of_Safety_N": MessageLookupByLibrary.simpleMessage(
      "Facteur de sécurité cible, n",
    ),
    "Target_Preload_F": MessageLookupByLibrary.simpleMessage(
      "Précontrainte cible, F",
    ),
    "Target_Safety_Factor_N": MessageLookupByLibrary.simpleMessage(
      "Facteur de sécurité cible, n",
    ),
    "Temperature_T": MessageLookupByLibrary.simpleMessage("Température, T"),
    ...
    "Torque_T": MessageLookupByLibrary.simpleMessage("Couple T"),
    "Torque_To_Lower": MessageLookupByLibrary.simpleMessage(
      "Couple de descente",
    ),
    "Torque_To_Raise": MessageLookupByLibrary.simpleMessage("Couple de montée"),
    ...
    "Truss_Analysis_Method_of_Joints": MessageLookupByLibrary.simpleMessage(
      "Analyse de treillis (méthode des nœuds)",
    ),
    "Truss_Geometry": MessageLookupByLibrary.simpleMessage(
      "Géométrie du treillis",
    ),
    "Truss_Statics": MessageLookupByLibrary.simpleMessage(
      "Treillis / Statique",
    ),
    "Ts_Diagram": MessageLookupByLibrary.simpleMessage("Diagramme T–s"),
    "Turbine_Efficiency": MessageLookupByLibrary.simpleMessage(
      "Rendement de la turbine, ηt (%)",
    ),
    "Turbine_Inlet_Optional": MessageLookupByLibrary.simpleMessage(
      "Température d’entrée turbine (facultatif)",
    ),
    "Turbine_Inlet_T3": MessageLookupByLibrary.simpleMessage(
      "Température d’entrée turbine, T₃",
    ),
    "Turbine_Work": MessageLookupByLibrary.simpleMessage(
      "Travail de turbine, w_t",
    ),
    "UDL": MessageLookupByLibrary.simpleMessage("Charge répartie"),
    "Ultimate_Strength": MessageLookupByLibrary.simpleMessage(
      "Résistance à la traction",
    ),
    "Ultimate_Strength_Sut": MessageLookupByLibrary.simpleMessage(
      "Résistance à la traction, Sut",
    ),
    "Unified_Coarse": MessageLookupByLibrary.simpleMessage(
      "Unified gros pas (UNC)",
    ),
    "Unified_Fine": MessageLookupByLibrary.simpleMessage(
      "Unified pas fin (UNF)",
    ),
    "Uniform_Distributed_Load_Full_Span": MessageLookupByLibrary.simpleMessage(
      "Charge uniformément répartie (toute la portée)",
    ),
    ...
    "Von_Mises_Alternating": MessageLookupByLibrary.simpleMessage(
      "Contrainte alternée de von Mises, σa′",
    ),
    "Von_Mises_Mean": MessageLookupByLibrary.simpleMessage(
      "Contrainte moyenne de von Mises, σm′",
    ),
    ...
    "Web_Thickness_Tw": MessageLookupByLibrary.simpleMessage(
      "Épaisseur d’âme, tw",
    ),
    "What_If": m42,
    ...
    "Wrap_Angle_Large_Pulley": MessageLookupByLibrary.simpleMessage(
      "Angle d\'enroulement, grande poulie",
    ),
    "Wrap_Angle_Small_Pulley": MessageLookupByLibrary.simpleMessage(
      "Angle d\'enroulement, petite poulie",
    ),
    "Yes_Habit": MessageLookupByLibrary.simpleMessage("Yes Habit"),
    "Yield_Strength": MessageLookupByLibrary.simpleMessage(
      "Limite d\'élasticité",
    ),
  };
}
